...
- **Dashboard**: User-friendly, fast, and productive. (Decoupled project [repo](./Saleor-Platform-docs.md) )
...
The easiest way to run all components of Saleor (API, storefront, and dashboard) together on your local machine is to use the [saleor-platform](./Saleor-Platform-docs.md) project. Go to that repository for instructions on how to use it.

[View saleor-platform Docs](./Saleor-Platform-docs.md)
...
For the dashboard documentation, go to the [saleor-dashboard](../saleor-dashboard/README.md)
